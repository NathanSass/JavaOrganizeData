...
/**
 * Created by nathansass on 10/6/15.
 */
...
public class KaraokeMachine {
    ...
    public void playNext() {
        ...
        if (song == null) {
            System.out.println("Sorry there are no songs in the queue. Use choose from the meny to add some");
        } else {
            System.out.printf("%n%n%n Open %s to hear %s by %s %n%nn",
                    song.getVideoUrl(),
                    song.getTitle(),
                    song.getArtist());
        }
